...
- [x] Create separate endpoints for (1) fetching all the todo items, (2) creating a new one, and (3) deleting an existing one (hint: don't forget `bodyParser`) // express.json parses the body, and there are endpoints for (4) update todo, (5) clear all
...
- [x] Also added: endpoints for update todo, clear all. Working on: sort, validation for post and patch.
